...
def AerSimulator(method='statevector', **kwargs):
    """
    Return an AerSimulator backend.

    Args:
        method (str): The simulation method to use for the backend.
        kwargs: Additional backend options.

    Returns:
        AerBackend: The AerSimulator backend instance.
    """
    aer_provider = AerProvider()
    backend = aer_provider.get_backend(method)
